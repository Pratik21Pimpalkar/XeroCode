    ...
    return (
        <section className="w-full ">
            <div className="flex flex-col mt-[100px] items-center w-full">
                <p className="[font-family:'Poppins-Bold',Helvetica] font-bold text-[#242331] text-[56px] text-center tracking-[0] leading-[70px]">
            ...
            <div className="flex flex-col items-center my-10  ">
                <p className=" self-stretch mt-[-1.00px] [font-family:'Nunito_Sans-Regular',Helvetica] font-normal text-[#797979] text-[24px] text-center tracking-[0] leading-[43.2px]">
